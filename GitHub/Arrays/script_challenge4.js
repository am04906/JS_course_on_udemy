...
// 2.
const dogSarahs = dogs.find(dog =>dog.owners.includes('Sarah'))
console.log(dogSarahs)
...
// 6. 7.
const dogEatOkay = dogs.filter(dog => dog.curFood > dog.recommendedFood*0.9 && dog.curFood < dog.recommendedFood*1.1)
